...
class Less_Functions{
	...
	public function rgba($r = null, $g = null, $b = null, $a = null){
		$rgb = array($r, $g, $b);
		$rgb = array_map(array('\Drupal\drupalexp\Less\Less_Functions','scaled'),$rgb);
	...
	public function round($n, $f = false) {
		...
		return $this->_math('\Drupal\drupalexp\Less\Less_Parser::round',null, $n, $fraction);
	}
    ...
    return $this->_isa($n, '\Drupal\drupalexp\Less\Less_Tree_Color');
	}

	public function isnumber($n) {
		return $this->_isa($n, '\Drupal\drupalexp\Less\Less_Tree_Dimension');
	}

	public function isstring($n) {
		return $this->_isa($n, '\Drupal\drupalexp\Less\Less_Tree_Quoted');
	}

	public function iskeyword($n) {
		return $this->_isa($n, '\Drupal\drupalexp\Less\Less_Tree_Keyword');
	}

	public function isurl($n) {
		return $this->_isa($n, '\Drupal\drupalexp\Less\Less_Tree_Url');
	}
