...
class Less_Tree_Ruleset extends Less_Tree{
	...
	public function genCSS( $output ){
      ...
      if( ($class === 'Drupal\drupalexp\Less\Less_Tree_Media') || ($class === 'Drupal\drupalexp\Less\Less_Tree_Directive') || ($this->root && $class === 'Drupal\drupalexp\Less\Less_Tree_Comment') || ($class === 'Drupal\drupalexp\Less\Less_Tree_Ruleset' && $rule->rules) ){
				$rulesetNodes[] = $rule;
			}else{
				$ruleNodes[] = $rule;
			}
